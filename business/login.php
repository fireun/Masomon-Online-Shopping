<?php
  ...
  if(isset($_POST['login'])){
    ...
    if($getInputName!="" && $getInputPass!=""){
      $sqlVerify = "SELECT * FROM seller WHERE (sellerName='$getInputName' OR email='$getInputName')";
      ...
      if($count == 1){//if have username and password  正确
        ...
        $sellerImage=$row['image'];
	  	  $HashPassword = $row['password'];

        if (password_verify($getInputPass, $HashPassword)) {
          $_SESSION['sellerId']=$sellerId;
          $_SESSION['sellerName']=$sellerName;
          $_SESSION['sellerImage']=$sellerImage;
          $_SESSION['m'] = "login-seller-account-success-notic-01";
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background:url(../images/sellerLogin.jpg);"></div>
              <div class="col-lg-6">
                <div class="p-5">
