<?php
  ...
  if(isset($_GET['edit-product-id'])){
      $edit_product_id = $_GET['edit-product-id'];

      //check status first
      $edit_check_product_sql = "SELECT * FROM product WHERE id = '$edit_product_id' AND status = '' AND auctionStatus = 'no'";
      ...
      if($result_Edit_Check_Product->num_rows > 0){
        while($row = $result_Edit_Check_Product->fetch_assoc()){
            $edit_product_name = $row['name'];
            $edit_product_price = $row['price'];
            $edit_product_category = $row['categoryId'];
            $edit_product_description = $row['description'];
            $edit_product_coverImage = $row['coverImage'];
            $edit_product_color = $row['color'];
            $edit_product_brand = $row['brand'];
            $edit_product_material = $row['material'];
            $edit_product_gender = $row['gender'];
            $edit_product_uploadTime = $row['uploadTime'];

            //get inventory
            $edit_inventory = "SELECT * FROM inventory WHERE productId = '$edit_product_id'";
            $result_Edit_Check_Inventory = $conn->query($edit_inventory);
            if($result_Edit_Check_Inventory->num_rows > 0){
                while($row = $result_Edit_Check_Inventory->fetch_assoc()){
                    $edit_product_totalStock = $row['totalStock'];
                }
            }

            //get catgory type
            $edit_category = "SELECT * FROM category WHERE categoryId = '$edit_product_category'";
            ...
            if($result_Edit_Check_Category->num_rows > 0){
                while($row = $result_Edit_Check_Category->fetch_assoc()){
                    $edit_product_category_name = $row['categoryType'];
                }
            }
        }
      }else{
...
<body id="page-top">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="createProduct.php">Create Product</a>
            ...
            <nav aria-label="breadcrumb" class="float-left">
              <ol class="breadcrumb">
                ...
                ?>
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $edit_product_name;?></li>
                <?php
                    }else{
                ?>
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4 " style="min-width: 95%;margin:0% 2%">
                <div class="card-header py-3 inline-block">
                    <?php 
                        if(isset($_GET['edit-product-id'])){ 
                    ?>
                        <h6 class="m-0 font-weight-bold text-primary"><i class="far fa-edit"></i> Edit Product</h6>
                    <?php 
                        }else{
                    ?>
                        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-folder-plus"></i> Add Product</h6>
                    <?php
                        }
                    ?>
                    </div>
             ...
             <form action="../database/seller/createProductProcess.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    <?php 
                        if(isset($_GET['edit-product-id'])){
                    ?>
                        <input type="hidden" name="editProductId" value="<?php echo $edit_product_id;?>">
                    <?php
                        }
                    ?>
                    <nav>
                        <div class="nav nav-tabs text-center" id="nav-tab" role="tablist">
                            <a class="col-md-4 nav-item nav-link text-info active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><i class="fas fa-cogs pr-3"></i>General</a>
                            <a class="col-md-4 nav-item nav-link text-info" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"><i class="fas fa-ruler pr-3"></i>Variation</a>
                            <a class="col-md-4 nav-item nav-link text-info" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false"><i class="far fa-images pr-3"></i>Media</a>
                        </div>
                    </nav>
                        ...
                        <div class="tab-content mt-3" id="nav-tabContent" >
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" >
                                ...
                                <div class="col-md-12 mt-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="productName"  class="form-control" placeholder="Product Name" value="<?php if(isset($_GET['edit-product-id'])){ echo $edit_product_name; }?>" required>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" class="textfield form-control" step=".01" id="extra7" name="productPrice" max="99999" onkeypress="return isNumber(event)"  placeholder="Product Price( RM )" value="<?php if(isset($_GET['edit-product-id'])){ echo $edit_product_price; }?>" required/>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <select class="custom-select" name="productCategory" id="select" onmousedown="if(this.options.length>8){this.size=8;}"  onchange='this.size=0;' onblur="this.size=0;">
                                                <?php 
                                                    if(isset($_GET['edit-product-id'])){
                                                ?>
                                                    <option selected value="<?php echo $edit_product_category;?>" ><?php echo $edit_product_category_name;?></option>
                                                <?php
                                                    }else{
                                                ?>
                                                    <option selected value="" disabled="disabled">-- Select The Product Category --</option>
                                                <?php
                                                    }
                                                ?>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <select class="custom-select" name="productColor" onmousedown="if(this.options.length>8){this.size=8;}"  onchange='this.size=0;' onblur="this.size=0;">
                                                <?php 
                                                    if(isset($_GET['edit-product-id'])){ 
                                                ?>
                                                    <option selected value="<?php echo $edit_product_color;?>"><?php echo $edit_product_color;?></option>
                                                <?php
                                                    }else{
                                                ?>
                                                    <option selected value="" disabled="disabled">-- Select The Product Color --</option>
                                                <?php
                                                    }
                                                ?>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <select class="custom-select" name="productGender" onmousedown="if(this.options.length>8){this.size=8;}"  onchange='this.size=0;' onblur="this.size=0;">
                                                <?php 
                                                    if(isset($_GET['edit-product-id'])){
                                                ?>
                                                    <option selected value="<?php echo $edit_product_gender;?>"><?php echo $edit_product_gender;?></option>
                                                <?php
                                                    }else{
                                                ?>
                                                    <option selected value="" disabled="disabled">-- Select The Gender --</option>
                                                <?php
                                                    }
                                                ?>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" name="productStock"  min="10" max="999" class="form-control"  onkeypress="return isNumber(event)" placeholder="Product Stock (miniman 10 & maximun 999)" value="<?php if(isset($_GET['edit-product-id'])){ echo $edit_product_totalStock; }?>" required>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="productBrand"  class="form-control" placeholder="Product Brand" value="<?php if(isset($_GET['edit-product-id'])){ echo $edit_product_brand; }?>">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Product Brand -->
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="productMaterial" class="form-control" placeholder="Product Material" value="<?php if(isset($_GET['edit-product-id'])){ echo $edit_product_material; }?>">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Product Stock -->
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <textarea name="productDescription" id="mytextarea" rows="10" cols="80">
                                                <?php 
                                                    if(isset($_GET['edit-product-id'])){ 
                                                        echo $edit_product_description;
                                                    }else{
                                                ?>
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                ...
                                <table class="table table-bordered table-hover table-sortable" id="tab_logic">
                                    ...
                                    <tbody>
                                        <?php 
                                            if(isset($_GET['edit-product-id'])){ 
                                                $getVariation = "SELECT * FROM variation WHERE productId = '$edit_product_id'";
                                                $resultgetVariation=$conn->query($getVariation);
                                                
                                                if($resultgetVariation->num_rows > 0){
                                                    $countEachRow = 1;
                                                    while($row = $resultgetVariation->fetch_assoc()){
                                                        $edit_product_variation_Id = $row['variationId'];
                                                        $edit_product_size = $row['variation'];      
                                                        $countEachRow++;            
                                        ?>
                                            <!-- if have variation  -->
                                            <tr id="<?php echo 'addr',$countEachRow?>" data-id="0" class="hidden">
                                                <td data-name="name">
                                                    <input type="text" name='EditvalueOfSize' placeholder='Product Variation' class="form-control" value="<?php echo $edit_product_size;?>" readonly/>
                                                </td>
                                                <td data-name="del">
                                                    <button type="button"  class='btn btn-danger glyphicon glyphicon-remove row-remove deleteVariationBtn submitBtn' data-editId="<?php echo $edit_product_id;?>" value="<?php echo $edit_product_variation_Id;?>" onclick="deleteVariation(this);"> 
                            ...
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row">0</th>
                                                    <td>
                                                        <img src="../images/productImage/<?php echo $edit_product_coverImage; ?>" width="100" height="100">
                                                    </td>
                                                    <td>
                                                        image
                                                    </td>
                                    ...
                                    <?php
                                        $edit_Get_Media_Statement = "SELECT * FROM productmedia WHERE productId = '$edit_product_id'";
                                        $resultEdit_Get_Media_Statement = $conn->query($edit_Get_Media_Statement);
                                        if($resultEdit_Get_Media_Statement->num_rows > 0){ //over 1 database(record) so run
                                            while($row = $resultEdit_Get_Media_Statement->fetch_assoc()){
                                                $edit_Product_File_id = $row['mediaId'];
                                                $edit_Product_File_Type = $row['fileType'];
                                                $count_Edit_Avaiable_Image = $count_Edit_Avaiable_Image - 1;
                                                $count_row ++;
                                            
                                                if($edit_Product_File_Type == "image"){
                                    ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger" value="<?php echo $edit_Product_File_id;?>" data-multiMediaId="<?php echo $edit_product_id;?>" onclick="deleteMultimedia(this)">
                                                            <i class="far fa-trash-alt"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                    <?php  
                                                }else if($edit_Product_File_Type == "video"){
                                    ?>
                                                <tr>
                                                    <th scope="row"><?php echo $count_row; ?></th>
                                                    <td>
                ...
                <div class="card-footer text-muted">
                    <div class="float-right">
                        <?php
                            if(isset($_GET['edit-product-id'])){
                        ?>
                            <button class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Update" name="updateProduct" type="submit">
                                <i class="fas fa-upload"></i>
                            </button>
                        <?php
                            }else{
                        ?>
                            <button class="btn btn-success" data-toggle="tooltip" data-placement="top" title="save" name="createProduct" type="submit">
                                <i class="far fa-save"></i>
                            </button>
                        <?php
                            }
                        ?>
                        <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="cancel" id="cancelBtn" type="button">
    ...
    <div class="modal fade" id="EditNewCoverImageModal" tabindex="-1" role="dialog" aria-labelledby="EditNewCoverImageModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                ...
                <input type="hidden" name="updateProductId" value="<?php echo $edit_product_id;?>">
  ...
  <script>
    ...
    function deleteVariation(removeId){
        ...
        var id = $(removeId).val();
        var editProductid = $(removeId).attr("data-editId");
    ...
    $(document).ready(function() {
        $("#add_row").on("click", function() {
            ...
            // loop through each td and create new elements with name of newid -> take where to generate new tr
    ...
    }else if(flashdata == "created-product-failed-unlogin-loginFirst-notic-01"){
        Swal.fire({
            icon: 'warning',
            title: 'Unlogin',
