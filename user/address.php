...
<body>
    ...
    <div class="col-md-12 profile-container">
        <div class="row">
            ...
            <!-- left list -->
            <div class="col-md-3 mobile-account-address-leftbox" style="padding-left:5%;">
                    ...
                    <div class="row pl-5">
                        ...
                        <!-- <div class="row"> -->
                            <ul class="account-ul-text">
                                ...
                                <li class="pt-1 profile-bar-link link-active" onclick='window.location.href="../user/address.php"'> Address </li>
            ...
            <!-- right box -->
            <div class="col-md-8 mobile-account-address-box">
            <form action="" method="post" >

                    <div class="row m-3">
                        <div class="col-md-12 border border-left-0 border-top-0 border-right-0 d-inline-flex">
                            <h3>Address</h3>
                            <button type="button" class="btn btn-danger mobile-create-address-btn" data-toggle="modal" data-target="#myModal">
                    ...
                    <div class="row ml-2">
                        ...
                        <div class="col-md-8">
                            <p>My address 1, jalan and taman, Skudai, Johor 81300 Malaysia.</p> <!--$address + $state + $city + $postal Code-->
                        </div>
                    </div>
                
                    <!-- <div class="row" style="margin: 7% 10% 1% 0%;float:right">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <div class="row mt-3">
                            <h5 class="text-muted">Address</h5>
                            <input type="text" name="address" id="" class="w-75" style="margin-left:38px;">
                        </div>
                        <div class="row mt-3 ">
                            <h5 class="text-muted">City</h5>
                            <select name="cars" class="custom-select w-75"  style="margin-left:65px;">
                        ...
                        <div class="row mt-3">
                            ...
                            <select name="cars" class="custom-select w-75"  style="margin-left:59px;">
                                <option selected>Custom Select Menu</option>
                        ...
                        <div class="row mt-3">
                            <h5 class="text-muted">Postal Code</h5>
                            <input type="text" name="postalCode" id="" class="ml-2 w-50">
                        </div>
                        <div class="row mt-3">
                            <h5 class="text-muted">Country</h5>
                            <select name="cars" class="custom-select w-75"  style="margin-left:34px;">
