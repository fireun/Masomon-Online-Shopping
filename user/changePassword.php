...
<body>
    ...
    <div class="col-md-12 profile-container">
        <div class="row">
                    ...
                    <div class="row pl-5">
                        ...
                        <!-- <div class="row"> -->
                            <ul class="account-ul-text">
                                ...
                                <li class="pt-1 profile-bar-link link-active"  onclick='window.location.href="../user/changePassword.php"'>Change Password </li>
                            </ul>
                        <!-- </div> -->
                    </div>
            ...
            <!-- right box -->
            <div class="col-md-8 changePassword-container" style="background:white;">
            <form action="" method="post" >
                    ...
                    <div class="col-md-8">
                        <!-- <div class="row"> -->
                            ...
                            <!-- password field -->
                            <div class="row mt-2">
                                <div class="col-md-5"><span class="text-danger">*</span> Current Password</div>
                                <div class="col-md-7">
                                    <input type="password" name="oldpass" id="">
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-5"><span class="text-danger">*</span> New Password</div>
                                <div class="col-md-7">
                                    <input type="password" name="oldpass" id="">
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-5"><span class="text-danger">*</span> Confirm New Password</div>
                                <div class="col-md-7">
                                    <input type="password" name="oldpass" id="">
                                </div>
                            ...
                            <div class="row mt-5">
                                    <button type="submit" class="btn btn-danger changePassword-submit-btn">Submit</button>
                            </div>
                        <!-- </div>End row -->
                    </div>
