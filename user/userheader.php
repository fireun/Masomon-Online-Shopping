            ...
            <div class="container">
                ...
                <div class="row row1">
                    <ul class="largenav pull-right">
                        <li class="upper-links"><a class="links" href="../user/auctionProduct.php">Laptop</a></li>
                        <!-- <li class="upper-links"><a class="links" href="https://campusbox.org/">Bluetooth Earphone</a></li> -->
                        <li class="upper-links"><a class="links" href="../user/auctionProduct.php">Speaker</a></li>
                        <li class="upper-links"><a class="links" href="../user/auctionProduct.php">Face Mask</a></li>
                        <li class="upper-links"><a class="links" href="../user/auctionProduct.php">Smartphone</a></li>
                ...
                <div class="row row2">
                    ...
                    <!-- search -->
                    <form action="../user/searchProduct.php" method="post" id="nav-search">
                        <div class="flipkart-navbar-search smallsearch col-sm-7 col-xs-11">
                            <div class="row mobile-mode-search-bar">
                                <input class="flipkart-navbar-input col-xs-11" name="search_box" id="search_box" type="text" placeholder="Search for Products, Brands and more" name="keyword">
                                <button type="submit" class="flipkart-navbar-button col-xs-1" name="search">
                    ...
                    <div class="cart largenav col-sm-2" id="shoppingbag">
                        ...
                        <div class="shopping-bag-detail" id="shoppingbagdetail">
                            <?php if(isset($_SESSION['username'])){ 
                                    $userId = $_SESSION['userId'];
                                    $getCartItem = "select * from cartintegration left join product on cartintegration.productId = product.id where cartintegration.userId = '$userId' LIMIT 1";
                                ...
                                ?>
                                    ...
                                    <hr>
                                    <div class="row">
                                            <p style="color:black;position:absolute;bottom:0px;;left:10px;">Available <strong><?php echo $CartCount;?></strong> in cart</p>
                            ...
                            <?php } 
                                    ...
                                    <div class="demo" style="z-index:100;color:black;padding:20%;font-size:15px">Empty Cart</div>                            
                            <?php        
                            }
                         }else { ?>
