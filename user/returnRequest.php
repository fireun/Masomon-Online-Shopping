        ...
        <div class="row">
                    ...
                    <div class="row pl-5 pt-2">
                        ...
                        <!-- <div class="row"> -->
                            <ul class="account-ul-text pt-1">
                                ...
                                <li class="pt-2 profile-bar-link link-active" onclick='window.location.href="../user/returnRequest.php"'>Return Request</li>
                            </ul>
                        <!-- </div> -->
                    </div>
            ...
            <div class="col-md-8 changePassword-container ">
                ...
                <div class="row m-3 shadow-sm p-3 bg-white ">
                    <h3 class="font-weight-bold">My Return Request</h3>
                </div>
                <!-- End title -->
                ...
                ?>
                   ...
                   <div class="row m-3 shadow-sm p-3 bg-white">
                        ...
                        <div class="col-2">
                            <a href="../user/returnProduct.php?productId=<?php echo $review_cart_integration_id;?>&action=view" class="btn btn-outline-info mt-4">View</a>  
                        </div>
                    </div>
                   <!-- End Display Review -->
                <?php
