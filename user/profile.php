...
if(isset($_SESSION['username'])){
    ...
    $getProfile = "Select * from user where userId = '$userId'";
    $resultGetProfile = $conn->query($getProfile);

    if($resultGetProfile->num_rows > 0){ //over 1 database(record) so run
        while($row = $resultGetProfile->fetch_assoc()){
    ...
    if(isset($_POST['updateProfile'])){
        if(empty($_FILES["userimage"])){
             ...
             $StoreName = basename($_FILES["userimage"]['name']);//original image name
        }
        ...
        $updatePhoneNo = $_POST['phonenumber'];
        $updateGender = $_POST['genderRadio'];
        $updateBirthday = $_POST['birthday'];

        echo $updateSql = "update user set userName='$updateName',firstName='$updateFirstName',lastName='$updateLastName',
                    email='$updateEmail',phoneNo='$updatePhoneNo',gender='$updateGender',birthday='$updateBirthday',image='$StoreName'
                     where userId = '$updateId'";

        $resultUpdate = $conn->query($updateSql);

        if($resultUpdate == true) {
            move_uploaded_file($_FILES["userimage"]["tmp_name"],$Imagetarget);
...
<body>
    ...
    <div class="col-md-12 profile-container">
        <div class="row">
            ...
            <!-- left list -->
            <div class="col-md-3 web-profile-bar" style="padding-left:5%;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 p-2 images-position">
                                ...
                                <?php
                                    ...
                                    <img src="../images/profileImage/<?php echo $image;?>" class="rounded-circle" alt="" width="60%" height="60%">
                                <?php }
                                }else{?>
                                    <img src="../images/userIcon.png" class="rounded-circle" alt="" width="60%" height="60%">
                                <?php } ?>
                            ...
                            <!-- name -->
                            <div class="col-md-8">
                                <h3 class="imges-box-underline"><?php echo $userName;?></h3>
                    ...
                    <div class="row pl-5">
                        ...
                        <!-- <div class="row"> -->
                            <ul class="account-ul-text">
                                <li class="pt-1 profile-bar-link link-active"  onclick='window.location.href="../user/profile.php"'> Profile </li>
            ...
            <!-- right box -->
            <div class="col-md-8 mobile-right-box-m" style="background:white;">

                    <div class="row m-3">
                        <div class="col-md-12 border border-left-0 border-top-0 border-right-0">
                            <h3>Profile</h3>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3 mt-2">
                            <div class="profile-images-upload">
                                <?php if(isset($_SESSION['username'])){
                                     if(empty($image)){ ?>
                                        <img src="../images/userIcon.png"  id="uimageBox" class="rounded-circle" alt="" width="100%" height="100%">
                                        <div class="profile-click-btn" id="UpdateText">Update</div>
                                <?php
                                     }else{?>
                                    <img src="../images/profileImage/<?php echo $image;?>" id="uimageBox" class="rounded-circle" alt="" width="100%" height="100%">
                                <?php }
                                }else{?>
                                <img src="../images/userIcon.png"  id="uimageBox" class="rounded-circle" alt="" width="100%" height="100%">
                                <div class="profile-click-btn" id="UpdateText">Update</div>
                                ...
                                <div class="upload-image-input-box">
                                        <input type="file" name="userimage" id="img-upload"
                        ...
                        <!-- input  -->
                        <div class="col-md-9 border border-top-0 border-right-0 border-bottom-0">
                            <div class="row" style="margin: 7% 0% 0% 4%;">
                                <h5>Username</h5>
                                <input type="hidden" name="userid" value="<?php echo $userId; ?>">
                                <input type="text" class="profile-input-username" name="username" id="" placeholder="Username" value="<?php echo $userName;?>">
                            </div>
                            <div class="row mobile-input-name">
                                <div class="col-md-5 d-inline-flex">
                                    <h5>First Name</h5>
                                    <input type="text" class="profile-input-firstname" name="firstName" id="" placeholder="First Name" value="<?php echo $firstName;?>">
                                </div>
                                <div class="col-md-5 d-inline-flex">
                                    <h5>Last Name</h5>
                                    <input type="text" class="profile-input-lastname" name="lastName" id="" placeholder="Last Name" value="<?php echo $lastName;?>">
                                </div>                  
                            </div>
                            <div class="row" style="margin: 4% 0% 0% 4%;">
                                <h5>Email</h5>
                                <input type="email" class="profile-input-email" name="email" id="" placeholder="email" value="<?php echo $email;?>">
                            </div>
                            <div class="row" style="margin: 4% 0% 0% 4%;">
                                <h5>Phone No</h5>
                                <input type="tel" class="profile-input-username" name="phonenumber" id="" placeholder="phone number" value="<?php echo $phone;?>">
                            </div>
                            <div class="row mobile-profile-gender">
                                <h5>Gender</h5>
                                <!-- <legend class="col-form-label col-sm-2 pt-0">Gender</legend> -->
                                <div class="col-sm-10 d-inline-flex mobile-profile-gender-radio">
                                    <div class="form-check">                                       
                                        <input class="form-check-input" type="radio" name="genderRadio" id="gridRadios1" value="male"  <?php if($gender=="male"){ echo "checked";}?> required/>
                                        <label class="form-check-label" for="gridRadios1">
                                            Male
                                        </label>
                                    </div>
                                    <div class="form-check" style="margin-left: 4%;">
                                        <input class="form-check-input" type="radio" name="genderRadio" id="gridRadios2" value="female"  <?php if($gender=="female"){ echo "checked";}?> required/>
                            ...
                            <div class="row" style="margin: 4% 0% 0% 4%;">
                                <h5>Date Of Birth</h5>
                                <input type="date" id="birthday" name="birthday" class="profile-input-birth" value="<?php echo $birthday;?>">
                            </div>
                            
                            <div class="row mobile-profile-submit-btn">
                                <button type="submit" name="updateProfile" class="btn btn-danger">Submit</button>
                            </div>
...
<script>
    $('#uimageBox').click(function(){
        $('#img-upload').click();
    });

    //view image before upload 
    function previewFile() {
        var preview = document.getElementById('uimageBox');//image layout place
