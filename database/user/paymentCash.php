...
$output='';
    ...
    {  
        ...
        // }else {  
            ...
            recipient_postalCode, recipient_country, user_id, created_time, update_time)  
            VALUES('$generateShipId','$name','$phone', '$address','$city' ,'$State','$postalCode','$country','$userId', '$date', '$date');  
            ";  
