<?php
    ...
    if(isset($_SESSION['sellerId'])){
        ...
        $productSQL = "select * from product where sellerId = '$sellerId' and auctionStatus = 'yes'";
...
<body>
    ...
    <div class="content" style="height:500px">
        ...
        <form action="viewAllAuction.php" method="post">
			<div class="container">
                <div class="well">
                    <table class="table">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <?php 
                                ...
                                if(isset($_SESSION['sellerId'])){
                                    $sellerId = $_SESSION['sellerId'];
                                    $productSQL = "select * from product where sellerId = '$sellerId' and  auctionStatus = 'yes'"." LIMIT ".$page1.", 3";
                                    $productResult = $conn->query($productSQL);
                                    if($productResult->num_rows > 0){ //over 1 database(record) so run
                                        while($row = $productResult->fetch_assoc()){
                                            $productId=$row['id'];
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="./createAuction.php?productId=<?php echo $productId; ?>" title="Edit" style="color:blue"><i class='fas fa-edit'></i></a>
            ...
            <div class="pagination-box">
                <nav aria-label="Page navigation example">
                    <ul class="pagination pagination-lg">                
                            <?php                                            
                                $result = $conn->query("SELECT * FROM product where auctionStatus = 'yes'");
                            ...
                            ?>
                            <?php for ($i = 1; $i <= $a; $i++) {?>
                                <li class="page-item"><a class="page-link" href="viewAllAuction.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li> 
                            <?php } ?>
